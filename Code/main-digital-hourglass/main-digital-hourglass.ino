...
void IR_Auswerten()
{
  ...
  {                                     // Wenn Daten empfangen wurden,
    ...
    for (int i = 0; i <= 9; i++)
    {
      ...
      if (aktiverModus == PGM_3)
        encoderWert[aktiverModus] * 10;
    }

    if (results.value == 16724175)
      encoderWert[aktiverModus] = 0;
    if (results.value == 16724175)
      encoderWert[aktiverModus] = 1;
    if (results.value == 16724175)
      encoderWert[aktiverModus] = 2;
    if (results.value == 16724175)
      encoderWert[aktiverWert] = 3;
    if (results.value == 16724175)
      encoderWert[aktiverWert] = 4;
    if (results.value == 16724175)
      encoderWert[aktiverWert] = 5;
    if (results.value == 16724175)
      encoderWert[aktiverWert] = 6;
    if (results.value == 16724175)
      encoderWert[aktiverWert] = 7;
    if (results.value == 16724175)
      encoderWert[aktiverWert] = 8;
    if (results.value == 16724175)
      encoderWert[aktiverWert] = 9;

    if (results.value == 16724175)
      encoderWert[aktiverModusverModus] += encoderIntervall[aktiverModus];
    if (results.value == 16724175)
